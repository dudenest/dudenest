...
class RelayClient {
  ...
  RelayClient(this.baseUrl, {http.Client? client, this.relayToken})
  ...
  dynamic _processResponse(http.Response resp, String context) {
    ...
    try {
      ...
      throw RelayException('$context: Failed to parse JSON: $e',
          statusCode: resp.statusCode, body: resp.body);
    }
  }
  ...
  Future<List<Map<String, dynamic>>> getProviders() async {
    final resp =
        await _http.get(Uri.parse('$baseUrl/providers'), headers: _headers);
    final data =
        _processResponse(resp, 'GET /providers') as Map<String, dynamic>;
  ...
  Future<Map<String, dynamic>> getAdminAccounts() async {
    final resp = await _http.get(Uri.parse('$baseUrl/admin/accounts'),
        headers: _headers);
    return _processResponse(resp, 'GET /admin/accounts')
  ...
  Future<Map<String, dynamic>> patchAdminAccount(
    ...
    return _processResponse(resp, 'PATCH /admin/accounts/$id')
        as Map<String, dynamic>;
  }
  ...
  Future<Map<String, dynamic>> reorderAdminAccounts(List<int> ids) async {
    ...
    return _processResponse(resp, 'POST /admin/accounts/reorder')
        as Map<String, dynamic>;
  }
  ...
  Future<Map<String, dynamic>> refreshAdminQuota(int id) async {
    ...
    return _processResponse(resp, 'POST /admin/accounts/$id/refresh-quota')
        as Map<String, dynamic>;
  }
  ...
  Future<Map<String, dynamic>> drainAdminAccount(int id) async {
    ...
    return _processResponse(resp, 'DELETE /admin/accounts/$id')
        as Map<String, dynamic>;
  }
  ...
  Future<Map<String, dynamic>> refreshAllAdminQuota() async {
    ...
    return _processResponse(resp, 'POST /admin/accounts/refresh-quota')
        as Map<String, dynamic>;
  }
  ...
  Future<Map<String, dynamic>> getDrainProgress(int id) async {
    ...
    return _processResponse(resp, 'GET /admin/accounts/$id/drain-progress')
        as Map<String, dynamic>;
  }
  ...
  Future<Map<String, dynamic>> getScanStatus() async {
    final resp = await _http.get(Uri.parse('$baseUrl/admin/scan/status'),
        headers: _headers);
    return _processResponse(resp, 'GET /admin/scan/status')
        as Map<String, dynamic>;
  }
  ...
  Future<Map<String, dynamic>> startScan(String providerID) async {
    final resp = await _http.post(
        Uri.parse(
            '$baseUrl/admin/scan/start?provider=${Uri.encodeQueryComponent(providerID)}'),
        headers: _headers);
    return _processResponse(resp, 'POST /admin/scan/start')
        as Map<String, dynamic>;
  }
  ...
  Future<Map<String, dynamic>> pauseScan(String providerID) async {
    final resp = await _http.post(
        Uri.parse(
            '$baseUrl/admin/scan/pause?provider=${Uri.encodeQueryComponent(providerID)}'),
        headers: _headers);
    return _processResponse(resp, 'POST /admin/scan/pause')
        as Map<String, dynamic>;
  }
  ...
  Future<Map<String, dynamic>> bootstrapWholeDrive(String providerID,
      {bool reset = false}) async {
    final qs =
        'provider=${Uri.encodeQueryComponent(providerID)}${reset ? "&reset=1" : ""}';
    final resp = await _http.post(
        Uri.parse('$baseUrl/admin/scan/bootstrap?$qs'),
        headers: _headers);
    return _processResponse(resp, 'POST /admin/scan/bootstrap')
        as Map<String, dynamic>;
  }
  ...
  Future<Map<String, dynamic>> patchAdminPolicy(
    ...
    return _processResponse(resp, 'PATCH /admin/policy')
        as Map<String, dynamic>;
  }
  ...
  Future<Map<String, dynamic>> fileManifest({String? since}) async {
    ...
    return _processResponse(resp, 'GET /files/manifest')
        as Map<String, dynamic>;
  }
  ...
  Future<Map<String, dynamic>> uploadFile(String filename, Uint8List bytes,
    ...
    final req = http.MultipartRequest(
        'POST', Uri.parse('$baseUrl/files/upload'))
  ...
  Future<Map<String, dynamic>> getFileMap(String fileId) async {
    final resp = await _http.get(Uri.parse('$baseUrl/files/$fileId/map'),
        headers: _headers);
    return _processResponse(resp, 'GET /files/$fileId/map')
        as Map<String, dynamic>;
  }
  ...
  Future<Uint8List> downloadFile(String fileId) async {
    ...
    if (resp.statusCode != 200) {
      throw RelayException('GET /files/$fileId: HTTP ${resp.statusCode}',
          statusCode: resp.statusCode, body: resp.body);
    }
  ...
  Future<void> authClose(String sessionId) async {
    final resp = await _http.post(Uri.parse('$baseUrl/auth/close/$sessionId'),
        headers: _headers);
  ...
  Future<Map<String, dynamic>> getAuthUrl(
      String provider, String callbackUri) async {
    final uri = Uri.parse('$baseUrl/auth/url').replace(
        queryParameters: {'provider': provider, 'callback': callbackUri});
    final resp = await _http.get(uri, headers: _headers);
  ...
  Future<Map<String, dynamic>> exchangeOAuthCode(
    ...
    return _processResponse(resp, 'POST /auth/exchange')
        as Map<String, dynamic>;
  }
  ...
  Future<Map<String, dynamic>> getMeta(String fileId) async {
    final resp = await _http.get(Uri.parse('$baseUrl/files/$fileId/meta'),
        headers: _headers);
    return _processResponse(resp, 'GET /files/$fileId/meta')
        as Map<String, dynamic>;
  }
  ...
  Future<Map<String, dynamic>> getRelayVersionInfo() async {
    final resp =
        await _http.get(Uri.parse('$baseUrl/admin/version'), headers: _headers);
  ...
  Future<Map<String, dynamic>> triggerRelayUpdate() async {
    final resp =
        await _http.post(Uri.parse('$baseUrl/admin/update'), headers: _headers);
