...
class RelayClient {
  ...
  Future<List<Map<String, dynamic>>> getProviders() async {
    final resp = await http.get(Uri.parse('$baseUrl/providers'));
  ...
  Future<List<Map<String, dynamic>>> listFiles() async {
    final resp = await http.get(Uri.parse('$baseUrl/files'));
  ...
  Future<Uint8List> downloadFile(String fileId) async {
    final resp = await http.get(Uri.parse('$baseUrl/files/$fileId'));
  ...
  Future<void> deleteFile(String fileId) async {
    final resp = await http.delete(Uri.parse('$baseUrl/files/$fileId'));
